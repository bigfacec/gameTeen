...
//  添加预算页面事件
  String budgetEventName = 'addBudget';
//facebook登陆成功事件
  String loginEventName = 'loginSuccess';
//  登录/退出回调
  String loginCallback = 'loginCallback';
//传递下载地址
  String downloadUrl = 'downloadUrl';
//  开始下载
  String StartDown = 'StartDown';
//  dio错误
  String error = 'error';
//  版本配置错误
  String errorVersion = 'errorVersion';
